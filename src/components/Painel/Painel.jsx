...
export default function Painel({ buscar }) {
  //Chamando a lista
  ...
  const filtrarLista = listaDesaparecidos.filter((item) =>
                ...
                {editandoId === item.id ? (
                  ...
                  <>
                    <div className={styles.containerPerfil}>
                      <img className={styles.perfil} src={item.imagem} alt="Imagem de perfil" />
